    ...
    function doConnect() {
        addClog('waiting for GATT server');
    ...
    function importCfg() {
        ...
        _text.innerHTML = 'Imported MI32Cfg';
        ...
        for(_sensor of importedJSON){
            ...
            try {
              ...
              addClog('no valid config, has no PID');
              return;
            }
            try {
            ...
            try {
              ...
              addClog('no valid config, has no MAC and/or key');
              return;
            }
            i += 1;
            addLog(result);
        ...
        document.getElementById("importedDev").innerHTML = " - " + importedJSON.length + " devices imported."
    }
    ...
    window.onload = function() {
        ...
        try{
          if(navigator.bluetooth.getAvailability()){
            addLog('Bluetooth support detected');
          }
          else{
            ...
            addLog('Bluetooth not supported by browser!! #enable-experimental-web-platform-features may help<br> for chrome-based browsers.');
