...
<div class="admonition danger"> <p>When doing an activation here the device is needed to be activated in the Mi app again when wanted to use there.</p> </div>
...
<button type="button" class="md-button md-button--primary" onclick="reConnect();" class="connected">Reconnect</button>
<button type="button" class="md-button md-button--primary" onclick="reload_page();" class="connected">Reset Page</button>
<button type="button" class="md-button md-button--primary" onclick="disconnect();" class="connected">Disconnect</button><hr>
<button type="button" class="md-button md-button--primary" onclick="sendRegister();" class="connected">Do Activation</button><br>
...
<div class="connected">
Device known id:<br>
<input size="34" type="text" id="known_id" value=""><br>
Mi Token:<br>
<input size="34" type="text" id="mi_token" value=""><br>
Mi Bind Key:<br>
<input size="34" type="text" id="mi_bind_key" value=""><br>
MAC:<br>
<input size="34" type="text" id="MAC" value=""><br>
</div>

<p>MI32CFG <span id='importedDev'></span></p>
<form><textarea id="result_config" cols="58" rows="10"></textarea></form>
<button type="button" class="md-button md-button--primary" onclick="importCfg();">Import cfg</button>
